...
export default function CustomerIdentityDialog() {
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-card">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold text-foreground mb-1">Submitted Successfully!</h2>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-[1%]">
      {/* Backdrop */}
      <div className="absolute inset-0 bg-scrim backdrop-blur-sm" onClick={handleClose} />

      {/* Dialog */}
      <div className="relative w-full h-full bg-card rounded-2xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
        {/* Close Button */}
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 z-10 w-9 h-9 rounded-full bg-card/90 backdrop-blur-sm flex items-center justify-center hover:bg-card transition-colors cursor-pointer shadow-sm"
        >
        ...
        <div className="relative lg:w-[45%] hidden lg:flex flex-col justify-end overflow-hidden">
          ...
          <div className="relative z-10 p-8 lg:p-10">
            <img
              ...
              className="h-12 mb-6"
            />
            <h2 className="font-serif text-3xl lg:text-4xl font-bold text-inverse leading-tight mb-2">
              Your Property Journey Starts with the{" "}
              <span className="text-accent">Right Guidance.</span>
            </h2>
            <div className="w-16 h-0.5 bg-accent mt-4 mb-4" />
          ...
          <div className="relative z-10 px-8 lg:px-10 pb-8 lg:pb-10 flex gap-3">
            <div className="flex items-center gap-2 bg-card/10 backdrop-blur-sm rounded-lg px-4 py-2.5 border border-inverse/10">
              <Globe className="w-5 h-5 text-accent" />
              <div>
                <p className="text-xs font-bold text-inverse">NRI / UHNI</p>
                <p className="text-[0.6rem] text-inverse-muted">Global Perspective. Trusted Guidance.</p>
              </div>
            </div>
            <div className="flex items-center gap-2 bg-card/10 backdrop-blur-sm rounded-lg px-4 py-2.5 border border-inverse/10">
              <Shield className="w-5 h-5 text-accent" />
              <div>
                <p className="text-xs font-bold text-inverse">Defence Personnel</p>
                <p className="text-[0.6rem] text-inverse-muted">Exclusive Care for Defence Families.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Mobile Header */}
        <div className="lg:hidden bg-primary p-5 pt-12">
          <img
            src="/images/logo/pf-logo-notext.webp"
            alt="Property Fifth"
            className="h-10 mb-3"
          />
          <h2 className="font-serif text-xl font-bold text-inverse">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-6 lg:p-10 lg:pt-10 max-w-lg mx-auto lg:max-w-none">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 text-sm border border-border rounded-lg bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-colors"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <div className="relative shrink-0">
                    ...
                    <div className="flex items-center gap-1 pl-10 pr-3 py-3 border border-border rounded-lg bg-muted text-sm text-foreground">
                      +91
                    </div>
                  </div>
                  <input
                    ...
                    className="flex-1 px-4 py-3 text-sm border border-border rounded-lg bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-colors"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <Globe className="w-7 h-7 text-accent mb-2" />
                    <p className="text-xs font-bold text-primary">NRI / UHNI</p>
                  ...
                  >
                    ...
                    <Shield className="w-7 h-7 text-accent mb-2" />
                    <p className="text-xs font-bold text-primary">Defence Personnel</p>
                    <p className="text-[0.6rem] text-muted-foreground mt-0.5 leading-tight">
              ...
              {/* Location Notice */}
              <div className="flex items-start gap-2.5 bg-muted rounded-lg p-3 border border-border-light">
              ...
              {/* Error */}
              {error && (
                <p className="text-xs text-destructive bg-destructive-bg border border-destructive-border rounded-lg px-3 py-2">
                  {error}
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={isPending}
                className="w-full flex items-center justify-center gap-2 bg-primary text-inverse font-bold text-sm py-3.5 rounded-lg hover:bg-[var(--navy-dark)] transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {isPending ? (
                  <>
